...
#define	LCD_PWR(n)		(n?gpio_bit_set(GPIOB,GPIO_PIN_7):gpio_bit_reset(GPIOB,GPIO_PIN_7))
#define	LCD_RST(n)		(n?gpio_bit_set(GPIOB,GPIO_PIN_6):gpio_bit_reset(GPIOB,GPIO_PIN_6))
#define	LCD_DC(n)			(n?gpio_bit_set(GPIOB,GPIO_PIN_4):gpio_bit_reset(GPIOB,GPIO_PIN_4))
